...
export default function ConsultPage() {
  ...
  return (
    <div className="p-16 pb-0 relative h-full">
      <NavLink to="/">
        <svg
      ...
      <div className="mt-20 h-fit flex flex-col justify-center items-center -ml-[13rem]">
        <h1 className="text-white font-bold text-[4rem] h-fit pb-24">
          您好！想咨询什么问题呢？
        </h1>
        <div
          className="relative"
          onClick={() => setIsConsultProcessing((prev) => !prev)}
        >
          <svg
            xmlns="http://www.w3.org/2000/svg"
            width="49"
            ...
            fill="none"
            className={
              '-right-8 -top-4 absolute ' +
              `${isConsultProcessing ? '' : 'opacity-0'}`
            }
          >
            <path
      ...
      <img
        src={doctorPng}
        alt=""
        className="absolute right-16 h-[80vh] bottom-0"
      />
    </div>
  );
}
